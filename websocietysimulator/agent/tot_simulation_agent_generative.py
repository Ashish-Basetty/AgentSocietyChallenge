...
from .modules.memory_modules import MemoryGenerative
import logging
...
class TOTSimulationAgentGenerative(SimulationAgent):
    """TOT Simulation Agent with Generative memory."""
    
    def __init__(self, llm: LLMBase):
        """Initialize TOTSimulationAgentGenerative"""
        super().__init__(llm=llm)
        logger = getattr(llm, 'logger', None)
        self.memory = MemoryGenerative(llm=self.llm, logger=logger)
